...
const getCategory = (merchant) => {
  ...
  if (lower.match(/zepto|blinkit|instamart|bigbasket|grofers|grocery|supermarket/)) return 'Groceries';
  if (lower.match(/uber|ola|rapido|irctc|makemytrip|metro|transport|travel|ticket|yatri/)) return 'Transport';
  if (lower.match(/amazon|flipkart|myntra|nykaa|reliance|dmart|shopping|mart|adidas|samsung|pai international/)) return 'Shopping';
